...
import '@zf/v3-core/contracts/libraries/SafeCast.sol';
import '@zf/v3-core/contracts/libraries/TickMath.sol';
import '@zf/v3-core/contracts/libraries/TickBitmap.sol';
...
contract QuoterV2 is IQuoterV2, IZFV3SwapCallback, PeripheryImmutableState {
    using Path for bytes;
    using SafeCast for uint256;
    using PoolTicksCounter for IZFV3Pool;
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) private view returns (IZFV3Pool) {
        return IZFV3Pool(PoolAddress.computeAddress(deployer, PoolAddress.getPoolKey(tokenA, tokenB, fee)));
    }

    /// @inheritdoc IZFV3SwapCallback
    function zfV3SwapCallback(
        ...
        IZFV3Pool pool = getPool(tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        IZFV3Pool pool = getPool(params.tokenIn, params.tokenOut, params.fee);
